...
public class SampleExcelUploadVo extends Page implements Serializable  {

	private static final long serialVersionUID = 8512714147574193788L;
	
	
	private String excelSysKnd;		// 시스템구분
