...
/**
 * @author j10000
 * @Description 샘플출고현황 현황 : CusSampleListServiceImpl implement
 * @Class : CusSampleListServiceImpl
 * <pre>
...
@Service("cusSampleListService")
public class CusSampleListServiceImpl  implements CusSampleListService{
	
	@Autowired
	CusSampleListMapper CusSampleListMapper;
	 ...
	 * @throws Exception
	 */
	public HashMap<String, Object> selectCusSampleList(CusSampleListVo paramVo) throws Exception {
		
	
		
		HashMap<String, Object> returnMap = new HashMap<String,Object>();
		List<CusSampleListVo> resultList = null;
		...
		resultList =  CusSampleListMapper.selectCusSampleList(paramVo);
