...
/**
 * @author j10000
 * @Description 매입입고 확인서 : BuyInspectListService implement
 * @Class : BuyConfirmServiceImpl
 * <pre>
...
@Service("buyInspectListService")
public class BuyInspectListServiceImpl  implements BuyInspectListService{
	
	@Autowired
	BuyInspectListMapper BuyInspectListMapper;
	...
	/**
	 *  매입처검수 확인 
	 * @param BuyConfirmVo paramVo
	 * @return HashMap<String, Object>
	 * @throws Exception
	 */
	public HashMap<String, Object> selectBuyConfirmList(BuyInspectListVo paramVo) throws Exception {
		
		HashMap<String, Object> returnMap = new HashMap<String,Object>();
		List<BuyInspectListVo> resultList = null;
		...
		resultList =  BuyInspectListMapper.selectBuyConfirmList(paramVo);
    ...
    */
	...
	public List<HashMap<String, String>> selectBuyInspectListExcelDown(BuyInspectListVo paramVo) throws Exception {
		return BuyInspectListMapper.selectBuyInspectListExcelDown(paramVo);
	}
}
