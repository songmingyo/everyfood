...
/**
 * @author j10000
 * @Description 기간별매입현황 : buyPeriodListService implement
...
@Service("buyPeriodListService")
public class BuyPeriodListServiceImpl  implements BuyPeriodListService{
	
	@Autowired
	BuyPeriodListMapper BuyPeriodListMapper;
	 ...
	 * @throws Exception
	 */
	public HashMap<String, Object> selectBuyPeriodList(BuyPeriodListVo paramVo) throws Exception {
		
	
		
		HashMap<String, Object> returnMap = new HashMap<String,Object>();
		List<BuyPeriodListVo> resultList = null;
		...
		resultList =  BuyPeriodListMapper.selectBuyPeriodList(paramVo);
	 ...
	 * @throws Exception
  */
	public BuyPeriodListVo selectBuyPeriodListData(BuyPeriodListVo paramVo) throws Exception {
		return  BuyPeriodListMapper.selectBuyPeriodListData(paramVo);
	}
	...
	public List<HashMap<String, String>> selectBuyPeriodListExcelDown(BuyPeriodListVo paramVo) throws Exception {
		return BuyPeriodListMapper.selectBuyPeriodListExcelDown(paramVo);
	}
	 ...
	 */
	@Override
	public List<BuyPeriodListVo> selectPeriodPrintList(BuyPeriodListVo paramVo) {
		return BuyPeriodListMapper.selectBuyPeriodPrtList(paramVo);
	}
}
