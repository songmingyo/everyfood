...
/**
 * @author Song
 * @Description 소비기한 관리 : ClsTermValListServiceImpl implement
 * @Class : ClsTermValListServiceImpl
 * <pre>
...
@Service("clsTermValListService")
public class ClsTermValListServiceImpl  implements ClsTermValListService{
	
	@Autowired
	ClsTermValListMapper clsTermValListMapper;
	 ...
	 * @throws Exception
	 */
	public HashMap<String, Object> selectClsTermValList(ClsTermValListVo paramVo) throws Exception {
		
	
		
		HashMap<String, Object> returnMap = new HashMap<String,Object>();
		List<ClsTermValListVo> resultList = null;
		...
		resultList = clsTermValListMapper.selectClsTermValList(paramVo);
	...
	public List<HashMap<String, String>> selectClsTermValListExcel(ClsTermValListVo paramVo) throws Exception {
		return clsTermValListMapper.selectClsTermValListExcel(paramVo);
	}
