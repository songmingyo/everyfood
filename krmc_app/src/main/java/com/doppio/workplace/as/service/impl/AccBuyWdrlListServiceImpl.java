...
/**
 * @author j10000
 * @Description 매입처별입금현황  : AccBuyWdrlListServiceImpl implement
 * @Class : AccBuyWdrlListServiceImpl
 * <pre>
...
@Service("accBuyWdrlListService")
public class AccBuyWdrlListServiceImpl  implements AccBuyWdrlListService{
	
	@Autowired
	AccBuyWdrlListMapper AccBuyWdrlListMapper;
	 ...
	 * @throws Exception
	 */
	public HashMap<String, Object> selectAccBuyWdrlList(AccBuyWdrlListVo paramVo) throws Exception {
		
	
		
		HashMap<String, Object> returnMap = new HashMap<String,Object>();
		List<AccBuyWdrlListVo> resultList = null;
		...
		resultList =  AccBuyWdrlListMapper.selectAccBuyWdrlList(paramVo);
