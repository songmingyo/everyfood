...
/**
 * @author j10000
 * @Description 외상매출금(상세)  : AccSalesDepListService implement
...
@Service("anlCreditSalesListService")
public class AnlCreditSalesListServiceImpl  implements AnlCreditSalesListService{
	
	@Autowired
	AnlCreditSalesListMapper AnlCreditSalesListMapper;
	 ...
	 * @throws Exception
	 */
	public HashMap<String, Object> selectAnlCreditSalesList(AnlCreditSalesListVo paramVo) throws Exception {
		
	
		
		HashMap<String, Object> returnMap = new HashMap<String,Object>();
		List<AnlCreditSalesListVo> resultList = null;
		...
		resultList =  AnlCreditSalesListMapper.selectAnlCreditSalesList(paramVo);
	...
	public List<AnlCreditSalesListVo> selectAnlCreditPrintList(AnlCreditSalesListVo paramVo) {
		return AnlCreditSalesListMapper.selectAnlCreditPrintList(paramVo);
	}
