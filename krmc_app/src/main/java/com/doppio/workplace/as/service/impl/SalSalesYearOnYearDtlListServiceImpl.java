...
/**
 * @author Song
 * @Description 전년대비매출처별매출현황(상세) : SalSalesYearOnYearDtlListServiceImpl implement
 * @Class : SalSalesYearOnYearDtlListServiceImpl
 * <pre>
...
@Service("salSalesYearOnYearDtlListService")
public class SalSalesYearOnYearDtlListServiceImpl  implements SalSalesYearOnYearDtlListService{
	
	@Autowired
	SalSalesYearOnYearDtlListMapper salSalesYearOnYearDtlListMapper;
	 ...
	 * @throws Exception
	 */
	public HashMap<String, Object> selectSalSalesYearOnYearDtlList(SalSalesYearOnYearDtlListVo paramVo) throws Exception {
		
	
		
		HashMap<String, Object> returnMap = new HashMap<String,Object>();
		List<SalSalesYearOnYearDtlListVo> resultList = null;
		...
		resultList = salSalesYearOnYearDtlListMapper.selectSalSalesYearOnYearDtlList(paramVo);
	 ...
	 * @param SalSalesYearOnYearDtlListVo paramVo
	 * @return SalSalesYearOnYearDtlListVo
	 * @throws Exception
	 */
	@Override
	public List<HashMap<String, String>> selectSalSalesYearOnYearDtlListExcelDown(SalSalesYearOnYearDtlListVo paramVo) throws Exception {
		return salSalesYearOnYearDtlListMapper.selectSalSalesYearOnYearDtlListExcelDown(paramVo);
	}
