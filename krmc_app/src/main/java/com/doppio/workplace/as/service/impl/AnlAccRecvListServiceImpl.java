...
/**
 * @author j10000
 * @Description 외상매입금  : AnlAccRecvListServiceImpl implement
 * @Class : AnlAccRecvListServiceImpl
 * <pre>
...
@Service("anlAccRecvListService")
public class AnlAccRecvListServiceImpl  implements AnlAccRecvListService{
	
	@Autowired
	AnlAccRecvListMapper AnlAccRecvListMapper;
	 ...
	 * @throws Exception
	 */
	public HashMap<String, Object> selectAnlAccRecvList(AnlAccRecvListVo paramVo) throws Exception {
		
	
		
		HashMap<String, Object> returnMap = new HashMap<String,Object>();
		List<AnlAccRecvListVo> resultList = null;
		...
		resultList =  AnlAccRecvListMapper.selectAnlAccRecvList(paramVo);
	 ...
	 * @return selectAccRecvPrintList
	 * @throws Exception
	 */
	@Override
	public List<AnlAccRecvListVo> selectAccRecvPrintList(AnlAccRecvListVo paramVo) throws Exception {
		return AnlAccRecvListMapper.selectAccRecvPrintList(paramVo);
	}
	
	/**
	 * 외상매입금 엑셀 다운로드 
	 * @param AnlAccRecvListVo paramVo
	 * @return AnlAccRecvListVo
	 * @throws Exception
	 */
	@Override
	public List<HashMap<String, String>> selectAnlAccRecvListExcelDown(AnlAccRecvListVo paramVo) throws Exception {
		return AnlAccRecvListMapper.selectAnlAccRecvListExcelDown(paramVo);
	}
