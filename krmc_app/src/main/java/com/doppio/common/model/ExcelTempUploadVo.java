...
public class ExcelTempUploadVo extends Page implements Serializable  {

	private static final long serialVersionUID = -2098815422179889528L;
	
	private String excelSysKnd;		// 시스템구분(점포개발, 시공, 컨세션, 정보관리)
	...
	private String regId;			// 등록자(userId로 등록해주세요!! memberCd 아님!!)
