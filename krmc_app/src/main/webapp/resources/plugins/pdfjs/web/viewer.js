...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = '/resources/plugins/pdfjs/web/images/';
  PDFJS.workerSrc = '/resources/plugins/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = '/resources/plugins/pdfjs/web/cmaps/';
