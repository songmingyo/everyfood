	...
	<div id="pop_content" class="open_content">
         <div id="pop_section">
            <div class="tit_area">
                ...
                <div><html:button id="btnInsertSave"    auth="save" msgKey="button.save"   /></div> <%--저장 --%>
            </div>
            ...
            <table class="type1" summary="<spring:message code="app.manager.memberviewmodpop.webacc.hdtag.table.summary" />"> <%--사용자정보 입력 --%>
                    ...
                    <tr>
                        ...
                        <td><input type="text" style="width: 140px; ime-mode:disabled;" name="userId" id="userId" onkeyup="chkByte(this,60);"  value="<c:out value='${data.userId}'></c:out>" >
                    ...
                    <tr>
                        ...
                        <td>
                        	<html:codeTag comType="SELECT" objId="userType" objName="userType" parentID="9001" subCode="1" defName="${commonChoice }" />
                        </td>
                        <th>* <spring:message code="app.manager.memberviewmodpop.label.email" /></th> <%--이메일 --%>
                        <td>
                        	<input type="text" style="width: 140px;  ime-mode:disabled; " name="email" id="email" value="<c:out value='${data.email}'></c:out>">
