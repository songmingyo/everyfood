...
//    	});
	...
	$('#find_salesmst_dataListbody').bind('resize', function() {
	    try{
	        ...
	        $('#find_salesmst_dataListbody').setGridWidth($('#find_salesmst_find_layer #gridcontainer').width()); //Resized to new width as per window
	    }catch(e){}
	}).trigger('resize');
}
	...
	$("#find_salesmst_dataListbody").jqGrid({
     ...
     // 헤더에 들어가는 이름
	    ...
	    colModel:[
	        ...
	        ,{name:'useYn'			, index:'useYn'			, hidden:true,	sortable:true		, width:100, 	align:"center"	}	/*이익율구분*/
...
/* 레이어호출 */
function commonSalesMstFindLayer(affiliate,hedoYn,searchVal_1,searchVal_2,callbackFnc,searchVal_3){
