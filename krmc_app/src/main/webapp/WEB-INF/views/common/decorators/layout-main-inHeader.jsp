...
.main-gbn h1{	margin-left: 30px; margin-right: 62px;}


.container h1{ float: left;}
.container nav{ text-align:left; margin-left:200px ;  height: 100%; }
...
#header .members:before{ content:''; display: inline-block; width: 19px; height: 19px; margin-right: 8px;  margin-left: 10px;  background: url(/resources/images/pearl/main/main_icon_26.png) no-repeat center center; background-size: 70% auto; vertical-align: middle}
#header .gbn-content-btn{ text-align: right;   }
#header .gbn-content-btn span{color:#474550; font-size:0.9em; display: inline-flex; align-items: center; margin-top:10px; margin-right: 10px; margin-bottom: 0; letter-spacing: -0.5px; }
#header .guest-join:before{content:'';   display: inline-block; width: 20px; height: 20px; margin-right: 2px; background: url(/resources/images/pearl/main/main_icon_23.png) no-repeat center center; background-size: 90%  auto; vertical-align: middle}
#header .guest-login:before{content:'';  display: inline-block; width: 20px; height: 20px; margin-right: 2px; background: url(/resources/images/pearl/main/main_icon_24.png) no-repeat center center; background-size: 70% auto;   vertical-align: middle}
#header .guest-logout:before{content:''; display: inline-block; width: 20px; height: 20px; margin-right: 2px; background: url(/resources/images/pearl/main/main_icon_25.png) no-repeat center center; background-size: 70% auto;   vertical-align: middle}


/* gnb */
#gnbframe {position: relative; z-index:1000; background-color: #fff;    }
...
#gnbframe .depth1 > a{position: relative; display: inline-block; padding: 0px 13px 24px; font-size: 18px; font-weight: 600}
...
<!--Content Head -->
		...
		<div class="main-gbn">
			<h1 ><a href="<c:url value="/"/>"><img src="/resources/images/pearl/main/logo.png" width="130px;"></a></h1>
					...
					<sec:authorize access="isAuthenticated()">
						...
						<c:choose>
							<c:when test="${userSession.userType == 'SA' || userSession.userType == 'SU'}">
								<span class="members" id="myInfo" style="cursor:pointer"><sec:authentication property="principal.fullName"/></span>
							</c:when>
							<c:otherwise>
								<span class="members" id="myInfo" style="cursor:pointer"><sec:authentication property="principal.fullName"/></span>
							</c:otherwise>
