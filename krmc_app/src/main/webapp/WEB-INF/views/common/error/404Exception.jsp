        ...
        <section class="content">
          ...
          <div class="error-page">
            <h2 class="headline text-yellow"> 404</h2>
              ...
              <h3><i class="fa fa-warning text-yellow"><strong><spring:message code="error.PageNotFound" /> </strong></i> </h3>
              <p>
               	<p><small class="text-red"><i class="fa fa-cog"></i> PageNotFoundError</small></p>
	          	<P><small class="errMessage"> <spring:message code="error.msg.access.denied.pagenotfound.title" /></small></p>
          		<p>
